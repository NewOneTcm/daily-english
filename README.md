...
精加工在独立的「生词库」标签页完成，刻意练习四步：

1. **AI 解释（结合原句）**：按词在原句里的意思给词性 + 释义 + 新例句，也可自己写
2. **造句练习**：用这个词造一句自己的话
3. **AI 点评造句**：深度复盘你造的句子；**多次点评会累积保留**，改了句子再点评，上一轮的记录还在
4. **点评逐条存学习库**：每条 AI 点评可单独「存到学习库」；单词本身也可一键存入——都进入间隔复习队列，可导出 SuperMemo
